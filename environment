...
export AB2_WORK_DIR=~/work
export AB2_PRIV_DIR=~/priv
export AB2_DEVEL_DIR=~/devel
export AB2_SHARE_DIR=~/share
...
# Path to the wiki
export WIKI="$HOME/Work/wiki"

# These are a personal things for my code
export BASHPATH="$HOME/Software/libs/bash"

# Lua path for for personal libs
export LUA_PATH="$HOME/Software/libs/lua/?.lua;;"
export LUA_CPATH="$HOME/Software/libs/lua/?.lua;;"
