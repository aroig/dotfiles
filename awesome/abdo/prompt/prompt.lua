...
local function prompt_text_with_cursor(args)
    ...
    ret = _prompt .. text_start .. "<span background=\"" .. args.cursor_color .. "\" foreground=\"" .. args.text_color .. "\" underline=\"" .. underline .. "\">" .. char .. "</span>" .. text_end .. spacer
    return ret
end
...
function prompt.run(args, textbox, exe_callback, completion_callback, history_path, history_max, done_callback, changed_callback, keypressed_callback)
    ...
    common.history_check_load(data.history, history_path, history_max)
    ...
    local exec = function()
        textbox:set_markup("")
        common.history_add(data.history, history_path, command)
