...
;;;;; diff
   ...
   `(diff-refine-added ((t (:foreground ,zenburn-bg :background ,zenburn-green+1 :weight bold))))
   `(diff-refine-change ((t (:foreground ,zenburn-bg :background ,zenburn-yellow-1 :weight bold))))
   `(diff-refine-removed ((t (:foreground ,zenburn-bg :background ,zenburn-red-1 :weight bold))))
...
;;;;; ediff
   ...
   `(ediff-even-diff-A ((t (:foreground nil :background ,zenburn-bg+1))))
   `(ediff-even-diff-Ancestor ((t (:foreground nil :background ,zenburn-bg+1))))
   `(ediff-even-diff-B ((t (:foreground nil :background ,zenburn-bg+1))))
   `(ediff-even-diff-C ((t (:foreground nil :background ,zenburn-bg+1))))
   ...
   `(ediff-odd-diff-A ((t (:foreground nil :background ,zenburn-bg+2))))
   `(ediff-odd-diff-Ancestor ((t (:foreground nil :background ,zenburn-bg+2))))
   `(ediff-odd-diff-B ((t (:foreground nil :background ,zenburn-bg+2))))
   `(ediff-odd-diff-C ((t (:foreground nil :background ,zenburn-bg+2))))
;;;;; egg
...
;;;;; org-mode
   ...
   `(org-level-4 ((t (:foreground ,zenburn-orange-1))))
   `(org-level-5 ((t (:foreground ,zenburn-green))))
   `(org-level-6 ((t (:foreground ,zenburn-blue-1))))
   `(org-level-7 ((t (:foreground ,zenburn-red-3))))
...
;;;;; outline
   ...
   `(outline-3 ((t (:foreground ,zenburn-blue-1   :weight normal))))
   `(outline-4 ((t (:foreground ,zenburn-yellow-2 :weight normal))))
   `(outline-5 ((t (:foreground ,zenburn-green+2  :weight normal))))
